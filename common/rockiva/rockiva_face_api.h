 ...
 * userData 用户自定义数据
 */
typedef void (*ROCKIVA_FACE_DetResultCallback)(const RockIvaFaceDetResult *result,
 ...
 * @return RockIvaRetCode
 */
RockIvaRetCode ROCKIVA_FACE_FeatureCompare(const void *feature1, const void *feature2,
                                           uint32_t featureLen, float *outScore);
 ...
 * @return RockIvaRetCode
 */
RockIvaRetCode ROCKIVA_FACE_FeatureLibraryModify(const char *libName, RockIvaFaceIdInfo *faceIdInfo,
                                                 uint32_t faceIdNum, const void *faceIdData,
 ...
 * @return RockIvaRetCode
 */
RockIvaRetCode ROCKIVA_FACE_SearchFeature(const char *libName, const void *featureData,
                                          uint32_t featureSize, uint32_t topK, uint32_t srcNum,
