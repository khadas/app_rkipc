...
```mermaid
graph LR
	VI_0[VI_0_2688*1520]-->AVS[AVS_FBC]
	VI_1[VI_1_2688*1520]-->AVS
	VI_2[VI_2_2688*1520]-->AVS
	VI_3[VI_3_2688*1520]-->AVS
	VI_4[VI_4_2688*1520]-->AVS
	VI_5[VI_5_2688*1520]-->AVS
	AVS-->VPSS-->VPSS_0_8192*2700_FBC-->VENC_0-->RTSP/RTMP/MUXER_0
	VPSS_0_8192*2700_FBC-->NPU
	VPSS-->VPSS_1_3840*1280_FBC-->VENC_1-->RTSP/RTMP_1
	VPSS-->VPSS_2_2048*680_FBC-->VENC_2-->RTSP/RTMP_2
	VPSS_2_2048*680_FBC-->VPSS_ROTATE-->VO
	VPSS-->VENC_3_8192*2700_NV12-->JPEG
```
